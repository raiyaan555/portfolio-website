...
export default function ProgressBar({
  ...
  return (
    <div className="origin-center scale-[0.68] whitespace-nowrap sm:scale-[0.8] md:scale-100">
      <div
      ...
      >
        {slides.map((slide, i) => (
          <button
            ...
            className="progress-tick flex-shrink-0 transition-colors duration-300"
